...
extension ResponsiveExtension on num {
  num get _width => SizeUtils.width ?? FIGMA_DESIGN_WIDTH; // Default to FIGMA width if not initialized
...
class SizeUtils {
  ...
  /// Device's Width
  static double? width; // Made nullable to prevent LateInitializationError
